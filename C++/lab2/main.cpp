...
int main(int argc, char **argv){
    ...
    //Figure A;
    cout << "X = " << aCrown.get_x() << endl;
    cout << "Y = " << aCrown.get_y() << endl;
    cout << "Color = " << aCrown.getColor() << endl;
    cout << "Index = " << aCrown.getIndex() << endl;
